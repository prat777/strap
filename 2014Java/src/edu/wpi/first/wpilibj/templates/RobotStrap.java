...
public class RobotStrap extends SimpleRobot
{
    ...
    private final DigitalInput fwdlim;
    private final DigitalInput bwdlim;
    ...
    public void operatorControl()
    {
        ...
        while (true && isOperatorControl() && isEnabled())
        {
    	    ...
    	    //double speed = (rightStick.getAxis(Joystick.AxisType.kY) - (-1)) / 2;
    
    	    //arm.set(rightStick.getAxis(Joystick.AxisType.kY));
